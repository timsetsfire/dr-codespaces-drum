...
def load_model(input_dir):
    ...
    SOME_PARAM = RuntimeParameters.get("SOME_PARAM")
    print( f"API_TOKEN = {API_TOKEN}, API_TOKEN type = {type(API_TOKEN)}")
    print( f"SOME_PARAM = {SOME_PARAM}, SOME_PARAM type = {type(SOME_PARAM)}")
